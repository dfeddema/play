...
#    sc.parallelize(range(10000)).saveAsTextFile("s3a://dianes-new-bucket/mynumbers")

     sc.textFile("s3a://dianes-new-bucket/mynumbers").take(5)
     print(repr(sc.textFile("s3a://dianes-new-bucket/mynumbers").take(5)))
# => [u'0', u'1', u'2', u'3', u'4']
